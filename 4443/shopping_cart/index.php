<?php
$conn=mysqli_connect("localhost","root","ThisIsNotAPasswordOrAnXFileOrAPipe4","RC");
require('backend.php');
        ...
        <div class="row">
            ...
            <div class="col-md-9">
				...
				<?php
					...
					$first_item = $start_row + 1;
					$end_row = $start_row + $RCstore->GetPageSize();
					$last_page = floor(($RCstore->GetNumItems()-1) / $RCstore->GetPageSize())+1;
				...
				<div class="col-sm-6">
					<nav>
					  <ul class="pagination">
						...
						<li><a href="#">Products: <?php echo"{$first_item} - {$end_row}";?> </a></li>
						<li><a href="<?php echo $_SERVER['PHP_SELF']."?cp=$next_page"?>"><span aria-hidden="true">&raquo;</span><span class="sr-only">Next</span></a></li>
						<li><a href="<?php echo $_SERVER['PHP_SELF']."?cp=$last_page"?>"><span aria-hidden="true">&raquo;&raquo;</span><span class="sr-only">Previous</span></a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 col-lg-4 col-md-4">
                        <div class="thumbnail">
                            <a href="" class="img-modal" data="'.$row['ProdID'].'"><img src="http://cdnll.rcplanet.com/images/xl/'.$row['ProdNum'].'.jpg" alt=""></a>
                            <div class="caption">
